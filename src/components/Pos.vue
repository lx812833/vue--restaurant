          ...
          <el-row>
                  ...
                  <el-tabs>
                      <el-tab-pane label="点餐" >
                          <el-table :data="tableData"  stripe border style="width:100%">
                              <el-table-column prop="goodsName" align="left" label="商品"></el-table-column>
                          ...
                          <div class="totalDiv">
                              <small>数量：</small>
                              <strong>{{totalCount}}</strong> 个&nbsp;&nbsp;&nbsp;&nbsp;
                              <small>总计：</small>
                              <strong>{{totalMoney}}</strong> 元
                          </div>
                          <div class="btn">
                                <el-button type="info" size="small">挂单</el-button>
                                <el-button type="warning" size="small" @click="delAllGoods">删除</el-button>
              ...
              <el-col :span='17'>
                  <div class="often-goods">
                      <div class="title">常用食品</div>
                      <div class="often-goods-list">
                          <ul>
                              <li v-for="(goods,key) in oftenGoods" @click="addOrderList(goods)">
